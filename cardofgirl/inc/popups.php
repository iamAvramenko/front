...
<div class="popup sign_up_1" id="sign_up_1">
    <div class="inner">
        ...
        <form method="POST" action="" class="step step2">
            <p>SIGN UP</p>
            <ul>
                <li><label for="radio_single_1"><input type="radio" name="profile" value="single" id="radio_single_1"
                                                     checked> Single profile</label></li>
                <li><label for="radio_multiple_1"><input type="radio" name="profile" value="multiple" id="radio_multiple_1">
                        Multiple profile</label></li>
            </ul>
            <label>Login</label>
            <input type="text" name="login">
